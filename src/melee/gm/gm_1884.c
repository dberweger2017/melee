...
typedef struct ClassicStageEnemyConfig {
    /* 0x0 */ u8 level;
    /* 0x1 */ u8 cpu_type;
    /* 0x2 */ u8 color;
} ClassicStageEnemyConfig;
ASSERT_SIZE(ClassicStageEnemyConfig, 3);
...
typedef struct ClassicStageEntry {
    ...
    /* 0x06 */ ClassicStageEnemyConfig enemies[3];
    /* 0x0F */ u8 pad_F;
} ClassicStageEntry;
    ...
    if (gm_801A45E8(2) != 0) {
        ...
        case 1:
            ...
            if (buttons & PAD_BUTTON_A) {
                ...
                item = lbl_803D9828[sub->menu_values[1]].item_id;
...
static char lbl_803D98C8[] = "ScGamTraining_scene_models";
static char lbl_803D98E4[] = "SdTrain.usd";
static char lbl_803D98F0[] = "SIS_TrainingData";
static char lbl_803D9904[] = "SdTrain.dat";
...
HSD_Text* fn_8018A000(void)
{
    ...
    if (lbLang_IsSavedLanguageUS()) {
        HSD_SisLib_803A62A0(0, lbl_803D98E4, lbl_803D98F0);
    } else {
        HSD_SisLib_803A62A0(0, lbl_803D9904, lbl_803D98F0);
    }
    ...
    *(text_ptr = &state->css.text) = HSD_SisLib_803A5ACC(
    ...
    text = *text_ptr;
    lbLang_IsSettingUS();
    HSD_SisLib_803A6368(text, lbl_803D9828[0].text_id);
...
ClassicStageEntry lbl_803D9910[65] = {
    { 0x04,
      ...
      50,
      170,
      { { 0, 1, 0x17 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      140,
      { { 1, 1, 0x17 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      80,
      120,
      { { 3, 1, 0x17 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      100,
      { { 5, 1, 0x17 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      95,
      { { 7, 1, 0x17 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 1, 2, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      140,
      { { 3, 2, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      80,
      115,
      { { 4, 2, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      100,
      { { 6, 2, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      95,
      { { 8, 2, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 2, 3, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      140,
      { { 4, 3, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      80,
      110,
      { { 5, 3, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      100,
      { { 7, 3, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      95,
      { { 9, 3, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 3, 1, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      140,
      { { 5, 1, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      80,
      120,
      { { 6, 1, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      105,
      { { 8, 1, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      95,
      { { 9, 1, 0x04 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 0, 2, 0x17 }, { 0, 2, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      67,
      140,
      { { 2, 2, 0x17 }, { 2, 2, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      78,
      120,
      { { 3, 2, 0x17 }, { 3, 2, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      105,
      { { 5, 2, 0x04 }, { 4, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      100,
      { { 6, 2, 0x04 }, { 6, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 1, 3, 0x17 }, { 1, 3, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      67,
      140,
      { { 3, 3, 0x04 }, { 3, 3, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      78,
      120,
      { { 4, 3, 0x04 }, { 3, 3, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      105,
      { { 5, 3, 0x04 }, { 5, 3, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      100,
      100,
      { { 7, 3, 0x04 }, { 7, 3, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 2, 1, 0x17 }, { 1, 1, 0x17 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      140,
      { { 3, 1, 0x04 }, { 3, 1, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      78,
      120,
      { { 4, 1, 0x04 }, { 4, 1, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      90,
      105,
      { { 6, 1, 0x04 }, { 5, 1, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      102,
      100,
      { { 8, 1, 0x04 }, { 7, 1, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 2, 2, 0x04 }, { 2, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      70,
      130,
      { { 3, 2, 0x04 }, { 3, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      80,
    ...
    { 0x02,
      ...
      90,
      105,
      { { 7, 2, 0x04 }, { 5, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      105,
      100,
      { { 9, 2, 0x04 }, { 8, 2, 0x04 }, { 0, 0, 0x00 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 0, 3, 0x17 }, { 0, 3, 0x17 }, { 0, 3, 0x17 } },
      0 },
    { 0x03,
      0,
      67,
      130,
      { { 2, 3, 0x17 }, { 2, 3, 0x17 }, { 1, 3, 0x17 } },
      0 },
    { 0x03,
      0,
      78,
      110,
      { { 3, 3, 0x17 }, { 3, 3, 0x17 }, { 3, 3, 0x17 } },
      0 },
    { 0x02,
      0,
      89,
      100,
      { { 4, 3, 0x04 }, { 4, 3, 0x17 }, { 4, 3, 0x17 } },
      0 },
    { 0x01,
      0,
      100,
      100,
      { { 6, 3, 0x04 }, { 6, 3, 0x04 }, { 6, 3, 0x17 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 1, 1, 0x17 }, { 1, 1, 0x17 }, { 1, 1, 0x17 } },
      0 },
    { 0x03,
      0,
      69,
      125,
      { { 2, 1, 0x17 }, { 2, 1, 0x17 }, { 2, 1, 0x17 } },
      0 },
    { 0x03,
      0,
      75,
      110,
      { { 4, 1, 0x11 }, { 4, 1, 0x17 }, { 3, 1, 0x17 } },
      0 },
    { 0x02,
      0,
      89,
      100,
      { { 5, 1, 0x04 }, { 4, 1, 0x11 }, { 4, 1, 0x17 } },
      0 },
    { 0x01,
      0,
      100,
      100,
      { { 7, 1, 0x04 }, { 7, 1, 0x04 }, { 7, 1, 0x11 } },
      0 },
    { 0x04,
      0,
      50,
      170,
      { { 1, 2, 0x17 }, { 1, 2, 0x17 }, { 1, 2, 0x17 } },
      0 },
    { 0x03,
      0,
      70,
      125,
      { { 3, 2, 0x11 }, { 3, 2, 0x17 }, { 3, 2, 0x17 } },
      0 },
    { 0x03,
      0,
      79,
      112,
      { { 4, 2, 0x04 }, { 4, 2, 0x11 }, { 4, 2, 0x17 } },
      0 },
    { 0x02,
      0,
      90,
      100,
      { { 5, 2, 0x04 }, { 5, 2, 0x04 }, { 4, 2, 0x11 } },
      0 },
    { 0x01,
      0,
      100,
      100,
      { { 8, 2, 0x04 }, { 8, 2, 0x04 }, { 7, 2, 0x04 } },
      0 },
    { 0x04,
      0,
      50,
    ...
    { 0x03,
      ...
      70,
      125,
      { { 4, 3, 0x11 }, { 4, 3, 0x04 }, { 3, 3, 0x17 } },
      0 },
    { 0x03,
      0,
      80,
      110,
      { { 5, 3, 0x04 }, { 4, 3, 0x11 }, { 4, 3, 0x17 } },
      0 },
    { 0x02,
      0,
      92,
      100,
      { { 6, 3, 0x04 }, { 5, 3, 0x04 }, { 5, 3, 0x11 } },
      0 },
    { 0x01,
      0,
      105,
      96,
      { { 9, 3, 0x04 }, { 8, 3, 0x04 }, { 8, 3, 0x11 } },
      0 },
    { 0x04,
      0,
      20,
      360,
      { { 1, 0, 0x00 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      30,
      320,
      { { 2, 0, 0x00 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x03,
      0,
      40,
      300,
      { { 3, 0, 0x00 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x02,
      0,
      48,
      240,
      { { 5, 0, 0x00 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
    { 0x01,
      0,
      55,
      200,
      { { 7, 0, 0x00 }, { 0, 0, 0x00 }, { 0, 0, 0x00 } },
      0 },
};
...
{
    return lbl_803D9910[stage_slot + (difficulty * 5)].enemies[idx].level;
}

u8 gm_8018A25C(u8 difficulty, u8 stage_slot, u8 arg2)
{
    return lbl_803D9910[stage_slot + difficulty * 5].enemies[arg2].cpu_type;
}

u8 gm_8018A290(u8 difficulty, u8 stage_slot, u8 idx)
{
    return lbl_803D9910[stage_slot + (difficulty * 5)].enemies[idx].color;
}
