...
{
    if (gen->cmdList == psCmdListArray[0][0x96]->cmdList)
    {
        hsd_8039D1E4(gen, lbl_803BF810);
    }
    if (gen->cmdList == psCmdListArray[0][0x97]->cmdList)
    {
        hsd_8039D1E4(gen, lbl_803BF810);
    }
    if (gen->cmdList == psCmdListArray[0][0x98]->cmdList)
    {
        hsd_8039D1E4(gen, lbl_803BF810);
    }
    if (gen->cmdList == psCmdListArray[0][0x21B]->cmdList)
    {
        hsd_8039D1E4(gen, lbl_803BF810);
    }
}
