...
Vec3 lbl_803EE324 = { -0.8f, 0.4f, 0.0f };
...
void mnNameNew_EnterFromMnCharSel(HSD_Archive* arg0, s32 arg1)
{
    ...
    if (is_us) {
        ...
        lbArchive_LoadSections(arg0, (void**) &AutoNamesList,
                               mnNameNew_803EE6F8, &NotAllowedNamesList,
                               mnNameNew_803EE708, NULL);
    }
...
char* mnNameNew_803EE720[] ATTRIBUTE_ALIGN(8) = {
    (char*) mnNameNew_804D4F98,
};
